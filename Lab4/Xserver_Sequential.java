...
public class Xserver {
	/* Xserver will run one thread and is conceived to be adapted easily to exercise 2 */
	...
	private static void handleConnection(Socket socket) throws IOException, InterruptedException {
		/* Handle the connection with 1 thread (designed to be easily parallelisable) */
